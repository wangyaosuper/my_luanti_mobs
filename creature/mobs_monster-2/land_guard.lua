...
local guard_types = {
	...
	{	nodes = {
		...
		drops = {
			...
			{name = "default:diamond", chance = 2, min = 0, max = 2},
			{name = "default:steel_ingot", chance = 1, min = 0, max = 2},
    		{name = "wool:white", chance = 2, min = 1, max = 3},
	...
	{	nodes = {
		...
		drops = {
			{name = "mobs:leather", chance = 2, min = 0, max = 2},
			{name = "default:mese_crystal", chance = 1, min = 0, max = 2},
 			{name = "default:steel_ingot", chance = 1, min = 0, max = 2},
    		{name = "wool:white", chance = 4, min = 1, max = 3},
    		{name = "farming:string", chance = 1, min = 1, max = 2},
			{name = "default:apple", chance = 1, min = 1, max = 2}
		},
	}
...
mobs:register_mob("mobs_monster:land_guard", {
	...
	drops = {
		{name = "mobs:leather", chance = 2, min = 0, max = 2},
		{name = "default:mese_crystal", chance = 1, min = 0, max = 2},
		{name = "default:diamond", chance = 1, min = 0, max = 1},
 		{name = "default:steel_ingot", chance = 1, min = 0, max = 2},
    	{name = "wool:white", chance = 2, min = 1, max = 3},
    	{name = "farming:string", chance = 1, min = 1, max = 2},
		{name = "default:apple", chance = 1, min = 1, max = 2}
