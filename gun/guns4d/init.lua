...
-- Writable temp path: prefer get_mod_data_path (Luanti 5.9+), fall back to worldpath
Guns4d.temp_path = (minetest.get_mod_data_path and minetest.get_mod_data_path() or (minetest.get_worldpath() .. "/guns4d_temp"))
if not Guns4d.temp_path:sub(-1):match("[/\\]") then
    Guns4d.temp_path = Guns4d.temp_path .. "/"
end
minetest.rmdir(Guns4d.temp_path, true)
minetest.mkdir(Guns4d.temp_path)
